...
public class ClientDetailFragment extends BaseFragment implements IFragment, Utils.UtilNetworkInterface, OnIconClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        clientObserver = new Observer<Client>() {
            ...
            public void onNext(Client client) {
                dismissProgress();
                setAdapter(client.getData().getClientdetail());
            }
